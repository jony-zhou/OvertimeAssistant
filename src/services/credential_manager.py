...
class CredentialManager:
        ...
        try:
            ...
            if key_str:
                ...
                keyring.set_password(
                    self.SERVICE_NAME, self.ENCRYPTION_KEY_NAME, key.decode()
                )
    ...
    def save_credentials(self, username: str, password: str) -> bool:
        ...
        try:
            ...
            keyring.set_password(self.SERVICE_NAME, password_key, encrypted_password)
    ...
    def load_credentials(self) -> Tuple[Optional[str], Optional[str]]:
        ...
        try:
            ...
            # 2. 讀取並解密密碼
            password_key = f"{self.PASSWORD_KEY_PREFIX}{username}"
            encrypted_password = keyring.get_password(self.SERVICE_NAME, password_key)
