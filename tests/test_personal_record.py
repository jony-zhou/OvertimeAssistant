...
class TestPersonalRecordIntegration:
    ...
    def test_multiple_records_aggregation(self):
        """測試多筆記錄聚合"""
        records = [
            PersonalRecord(date="2024/11/20", content="開發", status="核准", overtime_hours=2.5, monthly_total=2.5, quarterly_total=2.5, report_type="是"),
            PersonalRecord(date="2024/11/21", content="測試", status="核准", overtime_hours=3.0, monthly_total=5.5, quarterly_total=5.5, report_type="是"),
            PersonalRecord(date="2024/11/22", content="部署", status="核准", overtime_hours=1.5, monthly_total=7.0, quarterly_total=7.0, report_type="是"),
        ]
    ...
    def test_record_status_filtering(self):
        ...
        records = [
            PersonalRecord(date="2024/11/20", content="開發", status="核准", overtime_hours=2.5, monthly_total=2.5, quarterly_total=2.5, report_type="是"),
            PersonalRecord(date="2024/11/21", content="測試", status="待核", overtime_hours=3.0, monthly_total=5.5, quarterly_total=5.5, report_type="否"),
            PersonalRecord(date="2024/11/22", content="部署", status="核准", overtime_hours=1.5, monthly_total=7.0, quarterly_total=7.0, report_type="是"),
        ]
    ...
    def test_monthly_quarterly_totals(self):
        """測試當月和當季累計"""
        records = [
            PersonalRecord(date="2024/11/01", content="開發", status="核准", overtime_hours=2.0, monthly_total=2.0, quarterly_total=2.0, report_type="是"),
            PersonalRecord(date="2024/11/15", content="測試", status="核准", overtime_hours=3.0, monthly_total=5.0, quarterly_total=5.0, report_type="是"),
            PersonalRecord(date="2024/11/25", content="部署", status="核准", overtime_hours=2.5, monthly_total=7.5, quarterly_total=7.5, report_type="是"),
        ]
