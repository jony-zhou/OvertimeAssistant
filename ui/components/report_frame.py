...
class ReportFrame(ctk.CTkFrame):
    ...
    def _create_ui(self):
        ...
        title = ctk.CTkLabel(
            header, text="出勤異常清單(本月)", font=ctk.CTkFont(size=18, weight="bold")
        )
        ...
        self.refresh_button = ctk.CTkButton(
            button_container, text="🔄 重新整理", command=self.on_refresh, width=120
        )
        ...
        self.export_button = ctk.CTkButton(
            button_container, text="📥 匯出 Excel", command=self.on_export, width=120
        )
        ...
        self.stats_label = ctk.CTkLabel(
            self.stats_frame, text="", font=ctk.CTkFont(size=12), justify="left"
        )
